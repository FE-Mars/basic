 ...
 * @LastEditTime: 2023-07-30 21:03:09
        ...
        <page-main>
            <div class="list-wrap">
                ...
                <el-table :data="list" @selection-change="onSelectionChange">
                    ...
                    <el-table-column prop="target" label="分发对象" />
...
export default {
    ...
    data() {
        return {
            ...
            total: 0,
            list: [
                { name: 'hello.sdfs', target: '地面支撑系统', date_time: '2023-07-30 18:49:56' },
                { name: 'hello.sdfs', target: '科学分系统', date_time: '2023-07-30 18:49:56' }
            ],
            selections: []
        }
    },
